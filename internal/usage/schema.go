...
var usageSchemas = map[string]string{
	...
	"environment-templates":        "cmd \"environment-templates\" help=\"Operations for environment-templates\" {\n  alias \"et\"\n  cmd \"delete\" help=\"Delete an environment template\" {\n    arg \"template-id\" help=\"string value (or use --template-id)\"\n    flag \"--template-id <template_id>\" help=\"string value (or pass it as the [template-id] argument)\"\n  }\n  cmd \"list\" help=\"List environment templates\"\n}\n",
	"et":                           "cmd \"environment-templates\" help=\"Operations for environment-templates\" {\n  alias \"et\"\n  cmd \"delete\" help=\"Delete an environment template\" {\n    arg \"template-id\" help=\"string value (or use --template-id)\"\n    flag \"--template-id <template_id>\" help=\"string value (or pass it as the [template-id] argument)\"\n  }\n  cmd \"list\" help=\"List environment templates\"\n}\n",
	"environment-templates delete": "cmd \"delete\" help=\"Delete an environment template\" {\n  arg \"template-id\" help=\"string value (or use --template-id)\"\n  flag \"--template-id <template_id>\" help=\"string value (or pass it as the [template-id] argument)\"\n}\n",
	"environment-templates list":   "cmd \"list\" help=\"List environment templates\"\n",
