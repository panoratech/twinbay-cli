...
type SandboxRecords struct {
	rootSDK          *Twinbay
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newSandboxRecords(rootSDK *Twinbay, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *SandboxRecords {
	return &SandboxRecords{
		rootSDK:          rootSDK,
...
func (s *SandboxRecords) List(ctx context.Context, request operations.ListSandboxRecordsRequest, opts ...operations.Option) (*operations.ListSandboxRecordsResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/sandboxes/{sandbox_id}/twins/{sandbox_twin_id}/records/{resource}", request, nil)
	if err != nil {
	...
	res := &operations.ListSandboxRecordsResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization != nil && *o.SkipDeserialization {
				...
				var out []components.SandboxRecordResponse
				if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
					return nil, err
				}

				res.ResponseListSandboxRecords = out
			}
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
...
func (s *SandboxRecords) Update(ctx context.Context, request operations.UpdateSandboxRecordRequest, opts ...operations.Option) (*operations.UpdateSandboxRecordResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
		operations.SupportedOptionSkipDeserialization,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/sandboxes/{sandbox_id}/twins/{sandbox_twin_id}/records/{resource}/{external_id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.UpdateSandboxRecordResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
