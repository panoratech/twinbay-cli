...
func newSandboxTemplates(rootSDK *Twinbay, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *SandboxTemplates {
...
func (s *SandboxTemplates) List(ctx context.Context, opts ...operations.Option) (*operations.ListSandboxTemplatesResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/sandbox-templates")
	if err != nil {
	...
	res := &operations.ListSandboxTemplatesResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization != nil && *o.SkipDeserialization {
				...
				var out []components.SandboxTemplateResponse
				if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
					return nil, err
				}

				res.ResponseListSandboxTemplates = out
			}
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
...
func (s *SandboxTemplates) Delete(ctx context.Context, request operations.DeleteSandboxTemplateRequest, opts ...operations.Option) (*operations.DeleteSandboxTemplateResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
		operations.SupportedOptionSkipDeserialization,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/sandbox-templates/{template_id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.DeleteSandboxTemplateResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
