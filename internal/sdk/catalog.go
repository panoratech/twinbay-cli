...
// Catalog - Browse the digital twins available for new environments.
type Catalog struct {
	rootSDK          *Twinbay
...
func newCatalog(rootSDK *Twinbay, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Catalog {
	return &Catalog{
		rootSDK:          rootSDK,
...
func (s *Catalog) List(ctx context.Context, request *operations.ListTwinsRequest, opts ...operations.Option) (*operations.ListTwinsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/twins/catalog")
	if err != nil {
	...
	res := &operations.ListTwinsResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization != nil && *o.SkipDeserialization {
				...
				var out components.PageTwinResponse
				if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
					return nil, err
				}

				res.PageTwinResponse = &out
			}
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
...
// Retrieve a twin
func (s *Catalog) Retrieve(ctx context.Context, request operations.GetTwinRequest, opts ...operations.Option) (*operations.GetTwinResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
		operations.SupportedOptionSkipDeserialization,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/twins/catalog/{twin_slug}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetTwinResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization != nil && *o.SkipDeserialization {
				...
				var out components.TwinResponse
				if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
					return nil, err
				}

				res.TwinResponse = &out
			}
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
