...
func newSandboxLogs(rootSDK *Twinbay, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *SandboxLogs {
	return &SandboxLogs{
		rootSDK:          rootSDK,
...
func (s *SandboxLogs) List(ctx context.Context, request operations.ListRequestLogsRequest, opts ...operations.Option) (*operations.ListRequestLogsResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/sandboxes/{sandbox_id}/logs", request, nil)
	if err != nil {
...
func (s *SandboxLogs) Retrieve(ctx context.Context, request operations.GetRequestLogRequest, opts ...operations.Option) (*operations.GetRequestLogResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
		operations.SupportedOptionSkipDeserialization,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/sandboxes/{sandbox_id}/logs/{request_id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
