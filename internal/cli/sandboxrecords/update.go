...
func initUpdateCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Example: "  twinbay sandbox-records update --sandbox-id cf2a2465-9cde-4d4d-8896-6719d664c50d --sandbox-twin-id 76434c10-cd55-40e4-b5ac-f1ae38f16ed9 --resource <value> --external-id <id> --fields '{\"key\":\"<value>\"}'",
		Args:    cobra.NoArgs,
		RunE:    runUpdateCmd,
...
func runUpdateCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.SandboxRecords.Update(cmd.Context(), *req, sdkOpts...)
	if err != nil {
