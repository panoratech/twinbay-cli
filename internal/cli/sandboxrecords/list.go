...
func initListCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Example: "  twinbay sandbox-records list --sandbox-id 6f60bb85-deb3-43ae-bb26-ebef09e653bb --sandbox-twin-id 4283a66c-a030-40f0-a3d5-549f98bcda12 --resource <value>",
		Args:    cobra.NoArgs,
		RunE:    runListCmd,
...
func runListCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.SandboxRecords.List(cmd.Context(), *req, sdkOpts...)
	if err != nil {
