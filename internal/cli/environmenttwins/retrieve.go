...
func initRetrieveCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		Use:     "retrieve",
		Short:   "Retrieve an environment twin",
		...
		Example: "  twinbay environment-twins retrieve --environment-id 976bd5dd-5c1a-4781-9b8f-3e0e0de5753c --environment-twin-id bf38a22a-3f07-464b-9fae-45b4fe34325f",
		Args:    cobra.NoArgs,
		RunE:    runRetrieveCmd,
...
func runRetrieveCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.EnvironmentTwins.Retrieve(cmd.Context(), *req, sdkOpts...)
	if err != nil {
