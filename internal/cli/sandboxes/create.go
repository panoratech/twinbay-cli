...
func initCreateCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Long:    "Records the sandbox and queues each twin for provisioning. The twins are not serving yet: read each one with `wait_for=ready`, then collect its API key.",
