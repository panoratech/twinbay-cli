...
func initListCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Long:    "Saved environment definitions. Start an environment from one by sending its id as `template` to `POST /environments`.",
		Example: "  twinbay environment-templates list",
		Args:    cobra.NoArgs,
		RunE:    runListCmd,
		Annotations: map[string]string{
			"speakeasy_operation": "list_environment_templates",
		},
	}
...
func runListCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.EnvironmentTemplates.List(cmd.Context(), sdkOpts...)
	if err != nil {
