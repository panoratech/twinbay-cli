## twinbay organizations ensure-default
...
```
twinbay organizations ensure-default [flags]
```
...
* `twinbay organizations ensure-default --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `twinbay organizations ensure-default --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
