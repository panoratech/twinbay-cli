...
```
  twinbay twins start --twin-id 62eb3588-3e2d-43be-a97f-3a422b30ef51
```
...
* `twinbay twins start --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `twinbay twins start --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
