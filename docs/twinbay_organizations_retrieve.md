## twinbay organizations retrieve
...
```
twinbay organizations retrieve [flags]
```
...
* `twinbay organizations retrieve --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `twinbay organizations retrieve --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
