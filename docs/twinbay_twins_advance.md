...
```
  twinbay twins advance --twin-id 6676c26b-60f9-49d6-a691-a1177f475044
```
...
* `twinbay twins advance --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `twinbay twins advance --schema` — the exact JSON Schema of the request body (all `$ref`s bundled)
* `twinbay twins advance --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
