...
* `twinbay organizations list --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `twinbay organizations list --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
