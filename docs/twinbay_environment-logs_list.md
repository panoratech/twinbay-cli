...
```
  twinbay environment-logs list --environment-id c98df736-32e1-45b5-9dcc-bb15ab490740
```
...
* `twinbay environment-logs list --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `twinbay environment-logs list --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
