## twinbay environment-exports list
...
```
  twinbay environment-exports list --environment-id 78ebcd53-8df0-4789-a058-9e6fefab4b68
```
...
* `twinbay environment-exports list --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `twinbay environment-exports list --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
