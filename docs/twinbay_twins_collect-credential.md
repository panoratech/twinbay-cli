## twinbay twins collect-credential
...
```
  twinbay twins collect-credential --twin-id 82039d56-bcef-4032-8747-2d336ff541c0
```
...
* `twinbay twins collect-credential --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `twinbay twins collect-credential --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
