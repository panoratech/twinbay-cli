...
```
  twinbay twins stop --twin-id adda4683-c323-4731-8183-1c20c30ed724
```
...
* `twinbay twins stop --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `twinbay twins stop --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
