## twinbay twin-records update

Replace a twin record
...
* `twinbay twin-records update --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `twinbay twin-records update --schema` — the exact JSON Schema of the request body (all `$ref`s bundled)
* `twinbay twin-records update --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
