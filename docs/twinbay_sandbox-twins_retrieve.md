## twinbay sandbox-twins retrieve
...
```
twinbay sandbox-twins retrieve [flags]
```

### Examples

```
  twinbay sandbox-twins retrieve --sandbox-id eabe4821-32dd-4700-bca8-499c792546b5 --sandbox-twin-id e3de5d93-78fe-4214-8eef-52bf8c788302
```
...
* `twinbay sandbox-twins retrieve --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `twinbay sandbox-twins retrieve --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
