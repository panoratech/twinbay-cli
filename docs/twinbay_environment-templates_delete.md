## twinbay environment-templates delete
...
```
  twinbay environment-templates delete --template-id 88a23c18-dc84-4fba-8fa1-de867e687f5f
```
...
* `twinbay environment-templates delete --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `twinbay environment-templates delete --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
